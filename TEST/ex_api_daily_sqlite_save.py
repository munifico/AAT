...
파이썬 자료구조를 DataFrame 객체로 만드는 가장 쉬운 방법은 파이썬 딕셔너리를 사용하는 것.

키움 클래스의 인스턴스를 생성한 후 ohlcv 딕셔너리 추가.

데이터를 출력했던 코드를 자료구조 안으로 저장하도록 만듬
딕셔너리 키에 대응되는 파이썬 리스트에 값 추가.

ohlcv 딕셔너리를 DataFrame 객체로 변환.
...
if __name__ == "__main__":
    ...
    con = sqlite3.connect("D:\source\AAT\TEST\\stock.db")
